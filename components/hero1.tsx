...
// Layered photographic hero: local next/image fill, moss/green vignette,
// Palette 05 tokens, capability strip that overlaps the next section.
...
const Hero1 = ({
  ...
  return (
    <section className={cn("relative scroll-mt-0 text-bone", className)}>
      ...
      <div className="relative isolate min-h-svh overflow-hidden bg-brand-green">
        ...
        <div aria-hidden="true" className="absolute inset-x-0 bottom-0 h-px bg-smoke" />
        ...
        <div className="relative z-10 mx-auto flex min-h-svh max-w-[1440px] flex-col justify-end px-6 pb-28 pt-36 nav:pb-36 nav:pt-40">
          <div className="grid items-end gap-10 nav:grid-cols-12 nav:gap-12">
            <div className="nav:col-span-7">
              ...
              <p className="prose-measure mt-6 text-body text-bone/85">{description}</p>
            ...
            {secondaryImage && (
              <div className="relative hidden nav:col-span-5 nav:block">
                <div className="relative ml-auto aspect-4/5 w-full max-w-[380px] overflow-hidden rounded-card">
                  <Image
